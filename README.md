...
- **Test it:** see [REPRODUCE.md](research/candidates/0009-fusible-exponent-codebook/REPRODUCE.md).
...
uv run python research/candidates/0009-fusible-exponent-codebook/tools/reproduce.py --model /path/to/model.safetensors
```
...
[REPRODUCE.md](research/candidates/0009-fusible-exponent-codebook/REPRODUCE.md).
